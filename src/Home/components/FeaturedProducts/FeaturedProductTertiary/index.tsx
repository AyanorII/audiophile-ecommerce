...
export const FeaturedProductTertiary = () => {
	return (
		<div className="grid auto-rows-[200px] gap-3 md:auto-rows-[320px] md:grid-cols-2">
			<Card className="relative overflow-hidden bg-[url(/images/home/mobile/image-earphones-yx1.jpg)] bg-cover md:bg-[url(/images/home/tablet/image-earphones-yx1.jpg)] lg:bg-[url(/images/home/desktop/image-earphones-yx1.jpg)]" />
