export const PRODUCTS = [
	{
		...
		categoryImage: {
			mobile:
				"/images/product-yx1-earphones/mobile/image-category-page-preview.jpg",
			tablet:
				"/images/product-yx1-earphones/tablet/image-category-page-preview.jpg",
			desktop:
				"/images/product-yx1-earphones/desktop/image-category-page-preview.jpg",
		},
		new: true,
		price: 599,
		description:
	...
	},
	{
		...
		categoryImage: {
			mobile:
				"/images/product-xx59-headphones/mobile/image-category-page-preview.jpg",
			tablet:
				"/images/product-xx59-headphones/tablet/image-category-page-preview.jpg",
			desktop:
				"/images/product-xx59-headphones/desktop/image-category-page-preview.jpg",
		},
		new: false,
		price: 899,
		description:
		...
		others: [
			{
				...
				image: {
					...
					tablet: "/images/shared/tablet/image-xx99-mark-two-headphones.jpg",
					desktop: "/images/shared/desktop/image-xx99-mark-two-headphones.jpg",
				},
			},
			{
				slug: "xx99-mark-one-headphones",
	...
	},
	{
		...
		categoryImage: {
			mobile:
				"/images/product-xx99-mark-one-headphones/mobile/image-category-page-preview.jpg",
			tablet:
				"/images/product-xx99-mark-one-headphones/tablet/image-category-page-preview.jpg",
			desktop:
				"/images/product-xx99-mark-one-headphones/desktop/image-category-page-preview.jpg",
		},
		new: false,
		price: 1750,
		description:
		...
		gallery: {
			first: {
				mobile:
					"/images/product-xx99-mark-one-headphones/mobile/image-gallery-1.jpg",
				tablet:
			...
			second: {
				mobile:
					"/images/product-xx99-mark-one-headphones/mobile/image-gallery-2.jpg",
				tablet:
			...
			third: {
				mobile:
					"/images/product-xx99-mark-one-headphones/mobile/image-gallery-3.jpg",
				tablet:
	...
	},
	{
		...
		categoryImage: {
			mobile:
				"/images/product-xx99-mark-two-headphones/mobile/image-category-page-preview.jpg",
			tablet:
				"/images/product-xx99-mark-two-headphones/tablet/image-category-page-preview.jpg",
			desktop:
		...
		gallery: {
			first: {
				mobile:
					"/images/product-xx99-mark-two-headphones/mobile/image-gallery-1.jpg",
				tablet:
			...
			second: {
				mobile:
					"/images/product-xx99-mark-two-headphones/mobile/image-gallery-2.jpg",
				tablet:
			...
			third: {
				mobile:
					"/images/product-xx99-mark-two-headphones/mobile/image-gallery-3.jpg",
				tablet:
	...
	},
	{
		...
		categoryImage: {
			mobile:
				"/images/product-zx7-speaker/mobile/image-category-page-preview.jpg",
			tablet:
				"/images/product-zx7-speaker/tablet/image-category-page-preview.jpg",
			desktop:
	...
	},
	{
		...
		categoryImage: {
			mobile:
				"/images/product-zx9-speaker/mobile/image-category-page-preview.jpg",
			tablet:
				"/images/product-zx9-speaker/tablet/image-category-page-preview.jpg",
			desktop:
